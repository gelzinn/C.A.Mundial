      ...
      <main>
        ...
        <HelpContainer>
          <div className="help-content">
            ...
            <p id="about-info">
              As perguntas mais frequentes sobre a C.A.Mundial e seus serviços.
            </p>
              ...
              <ul>
                  ...
                  <li>
                    ...
                    <p>
                      ...
                      <p>
                        ...
                        presidente ou diretor responsável, representante de sua
                        ou alguma equipe ou organização de futebol, é possível
                        se inscrever e participar de nossos eventos.
                      </p>
                      <p>
                        <b>Como usuário:</b> caso você não tenha nenhuma relação
                        com qualquer equipe ou organização, é possível ainda
                        assim acompanhar os eventos, vendos os resultados,
                        estatísticas e tabelas do mesmo na página de cada um.
                      </p>
                    </p>
                  </li>
                  <li>
                    ...
                    <p>
                      No momento em que você, seu representante, ou presidente,
                      se inscrever em quaisquer evento realizado e organizado
                      pela C.A.Mundial, previamente à confirmação e para que a
                      inscrição seja concluída com êxito, haverá um
                      redirecionamento para realização de um pagamento.
                    </p>
                    <p>
                      O valor estará escrito em destaque na página para fazer da
                      conferência algo simples e prático, assim evitando
                      mal-entendidos.
                    </p>
                  </li>
                </ul>
                ...
                <ul>
                  <li>
                    ...
                    <p>
                      ...
                      excluído - tenha certeza ao realizar alguma ação dessa, ao
                      serem confirmadas, os dados não poderão ser recuperados.
                    </p>
                    <p>
                      Dados sigilosos, comprometedores e pessoais para que sejam
                      alterados, é necessário que o proprietário da conta faça
                      uma requisição no{" "}
                    ...
                    <p>
                      ...
                      plataforma, os dados estarão liberados por tempo limitado
                      para o usuário, assim podendo efetuar as mudanças
                      necessárias.
                    </p>
                  ...
                  <li>
                    ...
                    <p>
                      ...
                      consequentemente mais eficiente, para recuperação, podemos
                      resolver com você. Não se preocupe.
                    </p>
                    <p>
                      Entre em{" "}
                      <Link href="/contact">contato com o suporte</Link>.
                      Faremos o possível para ajudá-lo em relação a recuperação
                      de sua conta.
                    </p>
                  </li>
                </ul>
                ...
                <ul>
                  <li>
                    ...
                    <p>
                      ...
                      . Tendo essas informações em mente e estando ciente do que
                      foi dito anteriormente, vamos começar:
                      <p>
                        Acesse a página de{" "}
                        <Link href="/subscribe">cadastro</Link> da C.A.Mundial.
                        Será obrigatória a inserção de informações importantes,
                        como CNPJ da equipe, RG e CPF do presidente ou diretor
                        responsável e endereços, além de outros dados não tão
                        sigilosos, como nome e logo da equipe.
                      </p>
                    </p>
                  </li>
                  <li>
                    <span>
                      Será necessário se recadastrar após o fim de cada evento?
                    </span>
                    <p>
                    ...
                    <p>
                      A permanência de dados não será uma opção e a exclusão dos
                      mesmos pelo painel de controle será desativada apenas
                      durante a participação da equipe em algum evento.
                    </p>
                  </li>
                </ul>
                ...
                <ul>
                  <li>
                    ...
                    <p>
                      Essa é a parte mais simples, basta seguir o passo a passo
                      abaixo, os requisitos e as regras do evento.
                    </p>
                    <p>
                      Vá até a página de <Link href="/events">eventos</Link> e
                      procure o evento que deseja participar. Após localizá-lo,
                      clique sobre o botão ou nome do evento.
                    </p>
                    <p>
                      Dentro da página do evento, estarão descritas todas as
                      regras e informações referentes a ele. Um pouco abaixo,
                      haverá uma seção amarela, onde será possível a realização
                      da inscrição neste evento.
                    </p>
                  </li>
                  <li>
                    <span>
                ...
                <ul>
                  <li>
                    ...
                    <p>
                      Incrível que está conosco! A C.A.Mundial agradece muito a
                      sua preferência. Após cadastrado, acesse o{" "}
                      <a href="https://app.camundial.com.br/">
                        painel de controle
                      </a>{" "}
                ...
                <ul>
                  <li>
                    ...
                    <p>
                      ...
                      <Link href="/">página inicial</Link> do site, logo após o{" "}
                      <i>banner</i>.
                    </p>
                  </li>
                  <li>
                    <span>
                      Gostei dos eventos, quero me tornar um patrocinador. Como
                      faço?
                    </span>
                    <p>
                      Entre em{" "}
                ...
                <ul>
                  <li>
                    ...
                    <p>
                      Todas as suas informações contém criptografias de ponta a
                      ponta. Não se preocupe.
                    </p>
                    <p>
          ...
          <aside className="help-side">
            <div>
              <div className="info">
                ...
                <p>
                  Qualquer dúvida que não esteja prevista e descrita aqui, você
                  pode nos contatar.
                </p>
            ...
            <div>
              <div className="info">
                ...
                <p>
                  Não resolveu o problema por <i>chat</i>? Você pode nos ligar.
                </p>
                <p>
                  Estamos disponíveis durante os dias úteis, das 13 às 20 horas
                  - Horário de Brasília.
                </p>
              </div>
            </div>
            <div id="topics">
              ...
              <ul>
                <a>Primeiros passos</a>
                <a>Conta</a>
                <a>Cadastro</a>
                <a>Inscrição em eventos</a>
                <a>Minha equipe</a>
                <a>Patrocínio</a>
                <a>Privacidade</a>
                <a>Reembolso</a>
