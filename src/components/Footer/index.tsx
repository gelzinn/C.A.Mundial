...
export default function Footer() {
  ...
  return (
    <FooterContainer>
      <FastNavigation>
        <div className="container">
          <ul>
            ...
            <p>
              C.A.Mundial Promoção e Organização de Eventos Esportivos LTDA-ME.
            </p>
            <p>CNPJ: 06.043.445/0001-35</p>
          </ul>
          <ul>
            <span>Dúvidas</span>
          ...
          <ul>
            ...
            <a href="https://docs.camundial.com.br/">Locais sede</a>
            <a href="https://docs.camundial.com.br/">Patrocínios</a>
            <a href="https://docs.camundial.com.br/">Acomodação</a>
          </ul>
          <ul>
            <span>Recursos</span>
        ...
        <div className="container">
          ...
          <div className="follow-us">
            ...
            <div className="social-icons">
              <a
                target="_blank"
                href="https://www.instagram.com/camundial/"
                rel="noreferrer"
              >
                <svg
                  role="img"
              ...
              <a
                target="_blank"
                href="https://www.facebook.com/CAMundial"
                rel="noreferrer"
              >
                <svg
                  role="img"
              ...
              <a
                target="_blank"
                href="https://api.whatsapp.com/send?phone=5514991028512"
                rel="noreferrer"
              >
                <svg
                  role="img"
      ...
      {/* <CompanyLegalData>
        <p>
          CNPJ: 06.043.445/0001-35 • C.A.Mundial Promoção e Organização de
          Eventos Esportivos LTDA-ME.
        </p>
      </CompanyLegalData> */}
    </FooterContainer>
  );
